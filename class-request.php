...
?>
   ...
   $sql = ("SELECT `class_id`, `class_name`, `subject_name`, `class_days`, concat(class_start,' - ',class_end) as 'Time', `class_room`, `class_tags`, `class_description`, `class_adviser`, `class_dateCreate` FROM `tbl_class` WHERE  `class_adviser` =".$_SESSION['member_id']);
                        ...
                        if (mysqli_num_rows($results) > 0){
                            ...
                            echo "</tr>";
                                    ...
                                    include 'include/connect.php';
   $sql = ("SELECT class.`class_id` as 'class_id', class.`class_name` as 'class_name', class.`subject_name` as 'subject_name', class.`class_room` as 'class_room', memb.`member_fullname` as 'class_adviser'
...
WHERE clm.`verification` = 'No' AND clm.`member_id` =".$_SESSION['member_id']);
