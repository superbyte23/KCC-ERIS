...
<?php
            ...
            <div class="page-content">
               <?php include 'include/topbar.php'; ?>            
                ...
                <div class="page-content-wrap">
                    <form role="form" method="POST" action="test4.php">
                    <div class="row">
                        <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">                                            
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="quizname" id="quizname" placeholder="Enter title here....">
                            ...
                            <div class="col-md-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">                                            
                                        <select class="form-control" name="quizcat" id="quizcat">
                                            ...
                                            <?php
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    while($row = mysqli_fetch_assoc($result)) {
                                                        echo '<option value="'.$row['quizcat_id'].'" onclick="'.($row['quizcat_code']).'()">'.$row['quizcat_name'].'</option>';
                                                    }
                                                }
                                            ?>   
                                        </select>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-5 col-xs-12">
                                            <div class="input-group">
                                                <input class="form-control datepicker" name="quizdeadline" id="quizdeadline" type="text" placeholder="YYYY-mm-dd">
                                        ...
                                        <div class="col-md-5 col-xs-12">
                                            <div class="input-group">
                                                <input class="form-control timepicker" name="quizdeadlinetime" id="quizdeadlinetime" type="text" value="00:00 ">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            <input type="number" class="form-control" placeholder="Enter limit by minutes"  name="timelimit">
                                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                        </div>
                                    </div>
                                </div>  
    ...
    $(function(){
     ...
     $('#container_TF').append(
                                        ...
                                        +     '<select class="form-control select" name="answer[]">'
                                                        ...
                                                        + '<div class="row">'
                                                            + '<div class="col-md-2 col-xs-12">'
                                                                + '<div class="input-group">'
                                                                    ...
                                                                    + '<input type="text" class="form-control" name="choiceA[]" placeholder="Answer">'
                                                               + ' </div>'
                                                            + '</div>'
                                                            + '<div class="col-md-2 col-xs-12">'
                                                                + '<div class="input-group">'
                                                                    + '<span class="input-group-addon"><b>B</b></span>'
                                                                    + '<input type="text" class="form-control" name="choiceB[]" placeholder="Answer">'
                                                                + '</div>'
                                                            + '</div>'
                                                            + '<div class="col-md-2 col-xs-12">'
                                                                + '<div class="input-group">'
                                                                    + '<span class="input-group-addon"><b>C</b></span>'
                                                                    + '<input type="text" class="form-control" name="choiceC[]" placeholder="Answer">'
                                                                + '</div>'
                                                            + '</div>'
                                                            + '<div class="col-md-2 col-xs-12">'
                                                                + '<div class="input-group">'
                                                                    + '<span class="input-group-addon"><b>D</b></span>'
                                                                    + '<input type="text" class="form-control" name="choiceD[]" placeholder="Answer">'
                                                                + '</div>'
                                                            + '</div>'
