                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Subject List &nbsp&nbsp<a href="#" data-toggle="modal" data-target="#modal_small" class="btn btn-info active btn-rounded">Add New Subject</a></h3>
                                ...
                                <div class="panel-body">
                                    <table id="student" class="table datatable table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                                $Student = mysqli_query($conn,"SELECT * FROM `tbl_subject`");
                                                if (mysqli_num_rows($Student)>0) {
                                                    ...
                                                    echo '<tr>';
                                                        ...
                                                        echo '<td><button class="btn btn-info active btn-xs">View</button>&nbsp<a href="mod-delete/delete-subject.php?id='.$row['subj_id'].'" class="btn btn-danger active btn-xs">Delete</a></td>';
                                                    echo '</tr>';
                                                    }
                                                }
                                            ?>
        ...
        <div class="modal" id="modal_small" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <form class="form-horizontal" role="form" method="POST" action="add-module/addrooms.php">         
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                            <h4 class="modal-title" id="smallModalHead">Add New Subject</h4>
                        </div>
