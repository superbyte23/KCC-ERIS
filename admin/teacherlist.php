                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <table id="student" class="table datatable table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                                $Student = mysqli_query($conn,"SELECT M.member_fullname, T.user_id FROM tbl_members m LEFT JOIN tbl_teacher T ON M.member_id = T.member_id WHERE M.member_type = 'Teacher'");
