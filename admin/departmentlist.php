                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Department List &nbsp&nbsp<a href="#" data-toggle="modal" data-target="#modal_small" class="btn btn-info active btn-rounded">Add New Department</a></h3>
                                ...
                                <div class="panel-body">
                                    <table id="student" class="table datatable table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                                $Student = mysqli_query($conn,"SELECT * FROM `tbldepartment`");
