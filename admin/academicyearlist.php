                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Academic Year List &nbsp&nbsp<a href="#" data-toggle="modal" data-target="#modal_small" class="btn btn-info active btn-rounded">Add New AY</a></h3>
                                ...
                                <div class="panel-body">
                                    <table id="student" class="table datatable table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                                $Student = mysqli_query($conn,"SELECT * FROM `tbl_ay`");
                                                if (mysqli_num_rows($Student)>0) {
                                                    while ($row = mysqli_fetch_assoc($Student)) {
                                                    echo '<tr>';
                                                        echo '<td>'.$row['ay_ID'].'</td>';
                                                        echo '<td>'.$row['ay_Year'].'</td>'; 
                ...
                <div class="modal-content">
                    <form class="form-horizontal" role="form" method="POST" action="add-module/addrooms.php">         
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="smallModalHead">Add New Department</h4>
                        </div>
