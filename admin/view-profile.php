...
$sql = mysqli_query($conn, "SELECT * FROM tbl_members where member_id=".$_GET['id']);
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="panel panel-default">
                                <div class="panel-body profile" style="background-color: #1caf9a;">
                                ...
                                <div class="panel-body list-group border-bottom">
                                    ...
                                    <a href="manage-class.php" class="list-group-item"><span class="fa fa-coffee"></span> Class <span class="badge badge-default"><?php if ($member_type == 'Student') { echo($numclass); }elseif ($member_types == 'Teacher') {
                                       echo($Tnumclass);
                                    }  ?></span></a>                                
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading ui-draggable-handle">
                                    <h3 class="panel-title"><strong>User Profile Information</strong></h3>
                                </div>
                                <div class="panel-body">
                                    <!-- First Name -->
