    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <!-- END BREADCRUMB -->                                                
                <?php
                $sqlprofile = "SELECT * FROM tbl_members WHERE member_id = ".$_GET['id'];
                $result = mysqli_query($conn, $sqlprofile);
                if (mysqli_num_rows($result)> 0) {
                    while ( $r = mysqli_fetch_assoc($result)) {
                        $userid = $r['member_id'];
                        $Name = $r['member_fullname'];
                        $Uname = $r['member_username'];
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body profile" style="background: url('assets/images/gallery/wall.jpg') center center no-repeat;">
                                    <div class="profile-image">
                                        <img src="assets/images/users/no-image.jpg" alt="<?php echo($_SESSION['member_fullname']); ?>"/>
                                    </div>
                                    <div class="profile-data">
                                        <div class="profile-data-name" style="color: black;"><?php echo $Name; ?></div>
                                        <div class="profile-data-title">@<?php echo $Uname; ?></div>
