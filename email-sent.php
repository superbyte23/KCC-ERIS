                ...
                <div class="content-frame">                                    
                    ...
                    <div class="content-frame-top">                        
                        <div class="page-title">                    
                            <h2><span class="fa fa-inbox"></span> Sent Emails <!--<small>(3 unread)</small>--></h2>
                        </div>                                                                                
                    ...
                    <div class="content-frame-body">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body mail">
                                ...
                                $sql = "SELECT  * FROM emails WHERE  `sender_email` = '$member_email' ORDER BY `date_sent` DESC, `time_sent` DESC";

                                $result = mysqli_query($conn, $sql);

                                if (mysqli_num_rows($result)) {
                                   while ($row=mysqli_fetch_assoc($result)) {
                                       echo('<div class="mail-item mail-unread mail-info">                                    
                                    ...
                                    <div class="mail-user" style="width: 30%;">'.$row['receiver_email'].'</div>                                    
                                    <a href="email-message.php?id='.$row['email_id'].'" class="mail-text">'.$row['subject'].'</a>                                    
                                    <div class="mail-date">'.$row['date_sent'].', '.$row['time_sent'].'</div>
                                </div>');
                                   }
                                }
